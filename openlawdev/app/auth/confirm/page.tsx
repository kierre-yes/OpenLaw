...
export default async function ConfirmPage({
    ...
    return (
      <div className="flex flex-col gap-8 py-4">
        ...
        <div className="flex flex-col items-center gap-5 text-center">
          ...
          >
            <AlertTriangle className="w-7 h-7" style={{ color: "#A41F13" }} />
          </div>
        ...
        {/* Divider */}
        <div className="h-px w-full" style={{ backgroundColor: "rgba(41,47,54,0.08)" }} />
        ...
        <div className="flex flex-col items-center gap-5 text-center">
          <div className="relative flex items-center justify-center">
            ...
            <div
              ...
              style={{ backgroundColor: "rgba(164,31,19,0.08)" }}
            >
              <CheckCircle2 className="w-7 h-7" style={{ color: "#A41F13" }} />
            </div>
          </div>
          <div className="flex flex-col gap-2">
            <h2
  ...
  return (
    <div className="flex flex-col gap-8 py-4">
      ...
      >
        <p className="text-[12px] font-semibold uppercase tracking-widest" style={{ color: "#8F7A6E" }}>
          What to expect
        </p>
        {[
